...
def new_cust_name(account_number):
    ...
    new_customer_dict['first_name'] = first_name 
    new_customer_dict['last_name'] = last_name
    new_customer_dict['balance'] =  0 #note balance defaults to 0
